...
b8 vulkan_renderer_backend_initialize(renderer_backend* backend, const char* application_name, struct platform_state* plat_state) {
    ...
    application_get_framebuffer_size(&cached_framebuffer_width, &cached_framebuffer_width);
    ...
    app_info.pEngineName = "V2 Engine";
    ...
    for (u8 i = 0; i < context.swapchain.max_frames_in_flight; i++) {
        ...
        // This will prevent the application from waitng indefinitely for the first frame to render since it
